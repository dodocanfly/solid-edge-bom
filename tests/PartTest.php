...
use Dodocanfly\SolidEdgeBom\Part;
...
class PartTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->part0 = new Part($this->headers, $this->items[0]);
        $this->part26 = new Part($this->headers, $this->items[26]);
    }

    public function testGetMaterial()
    {
        self::assertEquals('Stal konstrukcyjna', $this->part0->getMaterial());
        self::assertEquals('#0,8 DC01, V8, R0,65', $this->part26->getMaterial());
    }
    ...
    public function testPartWithCustomHeadersMap()
    {
        ...
        $part33 = new Part($this->headers, $this->items[33], $customHeadersMap);
    ...
    public function testPartWithCustomHeadersAndMapNotExistingProperty()
    {
        ...
        $part = new Part($this->headers, $this->items[0], $customHeadersMap);
    }
